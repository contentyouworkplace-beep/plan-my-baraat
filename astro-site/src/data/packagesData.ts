...
export const BARAAT_PACKAGES: BaraatPackage[] = [
  {
    ...
    features: [
      ...
      "Professional DJ Artist — Non-Stop Entertainment",
      "Exclusive Sound Quality — Crystal Clear, Powerful, Premium",
      "Liquid CO₂ Gun — For a Dazzling Entry",
  ...
  },
  {
    ...
    features: [
      ...
      "Confetti CO₂ Gun — Premium Confetti CO₂ Gun",
      ...
      "Liquid CO₂ Gun — High Pressure Liquid CO₂ Effect",
