...
const CITY_COPY: Record<string, Partial<PageContent>> = {
  ...
  ahmedabad: {
    ...
    localArea: "We serve all major areas in Ahmedabad, including SG Highway, Satellite, Bodakdev, Prahlad Nagar, Vastrapur, Navrangpura, Maninagar, Bopal, South Bopal, Thaltej, Gota, Chandkheda, Naranpura, Shahibaug, Vastral, Nikol, and Paldi. From hotel driveways on SG Highway to lawns in Bopal and Sindhu Bhavan Road, we have managed entries across all venue types.",
