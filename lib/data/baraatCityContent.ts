...
export const BARAAT_CITY_CONTENT: Record<string, CityContent> = {
  ...
  "rajkot-sadar": {
    slug: "rajkot-sadar",
    intro:
      "Sadar is one of Rajkot's oldest, most central neighborhoods, packed with local shops, old-style buildings, and community halls that have hosted weddings for generations. A baraat entry here has that classic, old-Rajkot character.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Sadar's lanes are older and narrower than the newer parts of Rajkot, so we plan the truck's route carefully based on your exact venue, sometimes with a shorter walk-in for the final stretch.\n\nWe've handled entries in Sadar and know the area's older lanes well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Sadar that means knowing exactly where the truck can go and where a shorter walk-in works better, given the older lanes here.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Rajkot's oldest neighborhoods.",
    pricingGuidance:
      "On how much does baraat cost for a Sadar entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for a Sadar entry.\n\nA rough headcount for the baraati group and your exact venue helps us plan the route properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Sadar, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Sadar, Rajkot?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Can the truck reach venues in Sadar's older lanes?",
        a: "In most cases yes, though we check your exact venue in advance, since some lanes are narrower and may need a shorter walk-in for the final stretch.",
      },
      {
        q: "How early should I book for a Sadar wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Sadar a central part of Rajkot?",
        a: "Yes, it's one of the city's oldest, most central neighborhoods.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "rajkot-panchvati": {
    slug: "rajkot-panchvati",
    intro:
      "Panchvati is a well-settled residential neighborhood in Rajkot, known for its community halls and a strong sense of local identity. A baraat entry here has that comfortable, familiar neighborhood energy.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one team.",
    localArea:
      "Panchvati's roads are generally manageable for truck access, being a settled residential area, though we always confirm your exact venue's approach lane in advance.\n\nWe've handled entries in Panchvati and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Panchvati that means knowing this settled residential neighborhood and its community halls well.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Rajkot's residential neighborhoods.",
    pricingGuidance:
      "On how much does baraat cost for a Panchvati entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Panchvati, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Panchvati?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Are the roads here manageable for a truck entry?",
      ...
      {
        q: "How early should I book for a Panchvati wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Panchvati a residential area?",
        a: "Yes, it's a well-settled residential neighborhood with a strong local community.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "rajkot-vavdi": {
    slug: "rajkot-vavdi",
    intro:
      "Vavdi is a growing residential neighborhood on Rajkot's edge, with newer housing and a handful of venues that have opened as the area has developed. A baraat entry here fits the neighborhood's newer, more spread-out feel.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Vavdi's roads are a mix of newer development and older approach roads, so we plan the truck's route based on your exact venue. It's a bit further from central Rajkot.\n\nWe've handled entries in Vavdi and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Vavdi that means knowing the routes connecting this growing area to central Rajkot.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are comfortable with the longer routes common to this part of the city.",
    pricingGuidance:
      "On how much does baraat cost for a Vavdi entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group and your exact venue helps us plan the setup properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Vavdi, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Vavdi?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Vavdi far from central Rajkot?",
        a: "It's a bit further out, so factor in a slightly longer route for guests coming from the city center.",
      },
      {
        q: "How early should I book for a Vavdi wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Are Vavdi's roads good for a truck entry?",
        a: "Yes, though we check your exact venue in advance since this area has a mix of newer and older approach roads.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "rajkot-ayodhya-chowk": {
    slug: "rajkot-ayodhya-chowk",
    intro:
      "Ayodhya Chowk is a well-known junction area in Rajkot, close to several local halls and easy for guests from across the city to locate. A baraat entry here benefits from being at a central, recognizable point.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one booking.",
    localArea:
      "Ayodhya Chowk is a busy junction, so we plan the truck's arrival timing carefully to avoid the peak traffic windows around it. Venues nearby are generally easy to reach.\n\nWe've handled entries at venues near Ayodhya Chowk and know the timing that works best.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Ayodhya Chowk that means knowing exactly when to route the truck around this busy junction to avoid delays.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, keeping timing tight even near one of Rajkot's busier landmarks.",
    pricingGuidance:
      "On how much does baraat cost for an Ayodhya Chowk entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 3 weeks' notice during peak season is a safe bet, given how central and busy this landmark area is.\n\nA rough headcount for the baraati group and your exact venue helps us plan the timing properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue near Ayodhya Chowk, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost near Ayodhya Chowk?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Ayodhya Chowk a busy junction?",
        a: "Yes, it's a well-known, busy landmark area, so we plan the truck's arrival timing carefully around peak traffic.",
      },
      {
        q: "How early should I book for a wedding near Ayodhya Chowk?",
        a: "3 weeks ahead during wedding season (November to February) is a safe window.",
      },
      {
        q: "Is it easy for guests to find venues near Ayodhya Chowk?",
        a: "Yes, being a well-known landmark, it's easy for guests from across the city to locate.",
      },
      {
        q: "Is the vintage car included in every package?",
  ...
  "rajkot-aji-dam-road": {
    slug: "rajkot-aji-dam-road",
    intro:
      "Aji Dam Road runs alongside Rajkot's well-known reservoir, with open roads and some of the city's more scenic venues nearby. A baraat entry here has a bit of a scenic, relaxed feel compared to the busier central roads.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Aji Dam Road is generally wide and open, making truck access straightforward. Some venues here offer a scenic backdrop near the reservoir, which makes for great entry photos.\n\nWe've handled entries at venues along Aji Dam Road and know the area well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Aji Dam Road that means knowing which venues along this scenic stretch work best for a grand entry.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are comfortable with the open-road setups common in this part of the city.",
    pricingGuidance:
      "On how much does baraat cost for an Aji Dam Road entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 3 weeks' notice during peak season is a safe bet, since venues near the reservoir are popular.\n\nA rough headcount for the baraati group and your exact venue helps us plan the setup properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue on Aji Dam Road, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost on Aji Dam Road?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Are the venues on Aji Dam Road scenic?",
        a: "Yes, some venues here offer a scenic backdrop near the reservoir, which makes for great entry photos.",
      },
      {
        q: "How early should I book for an Aji Dam Road wedding?",
        a: "3 weeks ahead during wedding season (November to February) is a safe window, since venues near the reservoir are popular.",
      },
      {
        q: "Is Aji Dam Road good for a full truck entry?",
        a: "Yes, it's generally wide and open, making truck access straightforward.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-waghawadi-road": {
    slug: "bhavnagar-waghawadi-road",
    intro:
      "Waghawadi Road is one of Bhavnagar's busier, more developed stretches, home to several banquet halls and party venues. A baraat entry here draws attention along this well-known corridor.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team instead of separate vendors.",
    localArea:
      "Waghawadi Road is generally wide enough for truck access, though we plan the timing around its regular traffic. Venues here are easy for guests from across Bhavnagar to reach.\n\nWe've handled entries at venues along Waghawadi Road and know the area well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Waghawadi Road that means knowing how to time the truck's arrival around this corridor's regular traffic.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, keeping the whole entry punctual even on a busy road like this.",
    pricingGuidance:
      "On how much does baraat cost for a Waghawadi Road entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup and timing properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue on Waghawadi Road, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost on Waghawadi Road?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Waghawadi Road good for a truck entry?",
        a: "Yes, it's generally wide enough for truck access, and we plan timing around the road's regular traffic.",
      },
      {
        q: "How early should I book for a Waghawadi Road wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Waghawadi Road easy for guests to reach?",
        a: "Yes, it's a well-known, developed corridor easily reachable from across Bhavnagar.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-kaliyabid": {
    slug: "bhavnagar-kaliyabid",
    intro:
      "Kaliyabid is a well-established, central neighborhood in Bhavnagar, with a mix of shops, homes, and community halls that regularly host weddings. A baraat entry here has that classic, central-Bhavnagar feel.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one team.",
    localArea:
      "Kaliyabid's streets are a mix of older and newer stretches, so we plan the truck's route around your exact venue. It's centrally located and easy to reach.\n\nWe've handled entries in Kaliyabid and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Kaliyabid that means knowing which stretches of this central neighborhood work best for a full-size truck.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, keeping the whole entry punctual and organized.",
    pricingGuidance:
      "On how much does baraat cost for a Kaliyabid entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this central area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Kaliyabid, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Kaliyabid?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Kaliyabid centrally located?",
        a: "Yes, it's a well-established, central neighborhood in Bhavnagar, easily reachable from across the city.",
      },
      {
        q: "How early should I book for a Kaliyabid wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Can the truck reach venues in Kaliyabid?",
        a: "In most cases yes, though we check your exact venue in advance since this area has a mix of older and newer stretches.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-bhavnagar-town-center": {
    slug: "bhavnagar-bhavnagar-town-center",
    intro:
      "Bhavnagar Town Center is the heart of the city, with old-style markets, established halls, and easy access from every direction. A baraat entry here feels like a proper city-center celebration.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, so you don't have to arrange a dj truck rental, dhol group, car, and turban stylist separately.",
    localArea:
      "The town center has a mix of older, narrower lanes and some wider connecting roads, so we plan the truck's route carefully based on your exact venue.\n\nWe've handled entries in and around Bhavnagar's town center and know its lanes well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Bhavnagar's town center that means knowing exactly which lanes work for a full-size truck and where a shorter walk-in makes more sense.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through the city's older, denser core.",
    pricingGuidance:
      "On how much does baraat cost for a town center entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 3 weeks' notice during peak season is a safe bet, since town center venues are popular.\n\nA rough headcount for the baraati group and your exact venue helps us plan the route properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Bhavnagar's town center, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Bhavnagar's town center?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Can the truck reach venues in the town center's older lanes?",
      ...
      {
        q: "How early should I book for a town center wedding?",
        a: "3 weeks ahead during wedding season (November to February) is a safe window, since these venues are popular.",
      },
      {
        q: "Is the town center easy for guests to reach?",
        a: "Yes, it's the heart of Bhavnagar, with easy access from every direction.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-ghogha-circle": {
    slug: "bhavnagar-ghogha-circle",
    intro:
      "Ghogha Circle is a well-known junction in Bhavnagar, along the route toward Ghogha, with easy access from several parts of the city. A baraat entry here benefits from being at a central, recognizable point.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one booking.",
    localArea:
      "Ghogha Circle is a busy junction, so we plan the truck's arrival timing carefully to avoid the peak traffic windows around it. Venues nearby are generally easy to reach.\n\nWe've handled entries at venues near Ghogha Circle and know the timing that works best.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Ghogha Circle that means knowing exactly when to route the truck around this busy junction to avoid delays.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, keeping timing tight even near a busy landmark like this.",
    pricingGuidance:
      "On how much does baraat cost for a Ghogha Circle entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group and your exact venue helps us plan the timing properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue near Ghogha Circle, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost near Ghogha Circle?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Ghogha Circle a busy junction?",
        a: "Yes, it's a well-known, busy landmark area, so we plan the truck's arrival timing carefully around peak traffic.",
      },
      {
        q: "How early should I book for a wedding near Ghogha Circle?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is it easy for guests to find venues near Ghogha Circle?",
        a: "Yes, being a well-known landmark, it's easy for guests from across the city to locate.",
      },
      {
        q: "Is the vintage car included in every package?",
  ...
  "bhavnagar-sardarnagar": {
    slug: "bhavnagar-sardarnagar",
    intro:
      "Sardarnagar is a well-settled residential neighborhood in Bhavnagar, with a mix of community halls and local venues that regularly host weddings. A baraat entry here has that comfortable, familiar neighborhood feel.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Sardarnagar's roads are generally manageable for truck access, being a settled residential area, though we always confirm your exact venue's approach lane in advance.\n\nWe've handled entries in Sardarnagar and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Sardarnagar that means knowing this settled residential neighborhood and its community halls well.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Bhavnagar's residential neighborhoods.",
    pricingGuidance:
      "On how much does baraat cost for a Sardarnagar entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Sardarnagar, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Sardarnagar?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Are the roads here manageable for a truck entry?",
      ...
      {
        q: "Is Sardarnagar a residential area?",
        a: "Yes, it's a settled residential neighborhood with a good mix of community halls used for weddings.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-ghoghari-bazaar": {
    slug: "bhavnagar-ghoghari-bazaar",
    intro:
      "Ghoghari Bazaar is one of Bhavnagar's oldest market areas, packed with shops, old-style buildings, and community halls that have hosted weddings for generations. A baraat entry here has genuine old-city character.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Ghoghari Bazaar's lanes are older and narrower than the newer parts of Bhavnagar, so we plan the truck's route carefully based on your exact venue, sometimes with a shorter walk-in for the final stretch.\n\nWe've handled entries in Ghoghari Bazaar and know the area's older lanes well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Ghoghari Bazaar that means knowing exactly where the truck can go and where a shorter walk-in works better, given the older lanes here.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Bhavnagar's oldest market areas.",
    pricingGuidance:
      "On how much does baraat cost for a Ghoghari Bazaar entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for a Ghoghari Bazaar entry.\n\nA rough headcount for the baraati group and your exact venue helps us plan the route properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Ghoghari Bazaar, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Ghoghari Bazaar?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Can the truck reach venues in Ghoghari Bazaar's older lanes?",
        a: "In most cases yes, though we check your exact venue in advance, since some lanes are narrower and may need a shorter walk-in for the final stretch.",
      },
      {
        q: "How early should I book for a Ghoghari Bazaar wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Ghoghari Bazaar an old part of Bhavnagar?",
        a: "Yes, it's one of the city's oldest market areas, with genuine old-city character.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-ambavadi": {
    slug: "bhavnagar-ambavadi",
    intro:
      "Ambavadi is a well-settled residential neighborhood in Bhavnagar, known for its community halls and a strong sense of local identity. A baraat entry here has that comfortable, familiar neighborhood energy.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one team.",
    localArea:
      "Ambavadi's roads are generally manageable for truck access, being a settled residential area, though we always confirm your exact venue's approach lane in advance.\n\nWe've handled entries in Ambavadi and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Ambavadi that means knowing this settled residential neighborhood and its community halls well.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Bhavnagar's residential neighborhoods.",
    pricingGuidance:
      "On how much does baraat cost for an Ambavadi entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Ambavadi, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Ambavadi?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Are the roads here manageable for a truck entry?",
      ...
      {
        q: "How early should I book for an Ambavadi wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Ambavadi a residential area?",
        a: "Yes, it's a well-settled residential neighborhood with a strong local community.",
      },
      {
        q: "Is the vintage car included in every package?",
  ...
  "bhavnagar-nari-road": {
    slug: "bhavnagar-nari-road",
    intro:
      "Nari Road is a growing part of Bhavnagar, with newer development and a handful of venues that have opened as the area has expanded. A baraat entry here fits the neighborhood's newer, more spread-out feel.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Nari Road's roads are generally wide and newer, making truck access straightforward. It's a bit further from central Bhavnagar, so factor in a bit of extra travel time for guests.\n\nWe've handled entries on Nari Road and the surrounding newer development.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Nari Road that means being familiar with this newer, growing part of the city.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and stay up to date as new venues open in this area.",
    pricingGuidance:
      "On how much does baraat cost for a Nari Road entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group and your exact venue helps us plan the setup properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue on Nari Road, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost on Nari Road?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Nari Road far from central Bhavnagar?",
        a: "It's a bit further out, so factor in a bit of extra travel time for guests coming from the city center.",
      },
      {
        q: "How early should I book for a Nari Road wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Are Nari Road's roads good for a truck entry?",
        a: "Yes, being newer development, the roads here are generally wide and straightforward.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "bhavnagar-takhteshwar-area": {
    slug: "bhavnagar-takhteshwar-area",
    intro:
      "The Takhteshwar area sits near Bhavnagar's well-known hilltop temple, with a mix of residential streets and a few venues that offer a bit of a scenic setting. A baraat entry here has a slightly elevated, relaxed feel compared to the busier central roads.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "The Takhteshwar area has a mix of residential streets, some with a gentle incline toward the temple. We check your exact venue's approach in advance to plan the truck's route properly.\n\nWe've handled entries near the Takhteshwar area and know the streets well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for the Takhteshwar area that means knowing which streets near the temple work best for a full-size truck.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are comfortable planning around this area's gentle slopes and residential streets.",
    pricingGuidance:
      "On how much does baraat cost for a Takhteshwar area entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group and your exact venue helps us plan the route properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue near the Takhteshwar area, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost near the Takhteshwar area?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Are the streets near Takhteshwar good for a truck entry?",
        a: "We check your exact venue's approach in advance, since some streets have a gentle incline toward the temple.",
      },
      {
        q: "How early should I book for a wedding near this area?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is this area near the Takhteshwar temple?",
        a: "Yes, it's a residential area near Bhavnagar's well-known hilltop temple.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "jamnagar-bedi": {
    slug: "jamnagar-bedi",
    intro:
      "Bedi is a well-known port-side neighborhood in Jamnagar, with a mix of older lanes and newer development near the coast. A baraat entry here has a bit of a coastal, laid-back character.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Bedi's streets are a mix of older lanes near the port and newer approach roads, so we plan the truck's route based on your exact venue.\n\nWe've handled entries in Bedi and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Bedi that means knowing which lanes work for a full-size truck near the port area.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Jamnagar's coastal neighborhoods.",
    pricingGuidance:
      "On how much does baraat cost for a Bedi entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Bedi, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Bedi, Jamnagar?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Can the truck reach venues in Bedi's older lanes?",
        a: "In most cases yes, though we check your exact venue in advance since some lanes near the port are narrower.",
      },
      {
        q: "How early should I book for a Bedi wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Bedi a coastal area?",
        a: "Yes, it's a well-known port-side neighborhood with a bit of a coastal character.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "jamnagar-digjam": {
    slug: "jamnagar-digjam",
    intro:
      "Digjam is a well-known residential and industrial neighborhood in Jamnagar, named after the famous textile mill in the area. A baraat entry here draws on a mix of working-class and settled family crowds.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one team.",
    localArea:
      "Digjam's roads are a mix of industrial approach roads and residential lanes, so we plan the truck's route based on your exact venue.\n\nWe've handled entries in Digjam and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Digjam that means knowing which lanes work for a full-size truck given the mix of industrial and residential roads here.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through this kind of mixed-use neighborhood.",
    pricingGuidance:
      "On how much does baraat cost for a Digjam entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Digjam, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Digjam?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Can the truck reach venues in Digjam?",
        a: "In most cases yes, though we check your exact venue in advance given the mix of industrial and residential roads here.",
      },
      {
        q: "How early should I book for a Digjam wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Digjam close to central Jamnagar?",
        a: "Yes, it's a well-known neighborhood within reach of the rest of the city.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "jamnagar-pandit-nehru-marg": {
    slug: "jamnagar-pandit-nehru-marg",
    intro:
      "Pandit Nehru Marg is one of Jamnagar's well-known central roads, home to several established venues and easy access from across the city. A baraat entry here has that classic, central-Jamnagar energy.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, so you don't have to arrange a dj truck rental, dhol group, car, and turban stylist separately.",
    localArea:
      "Pandit Nehru Marg is centrally located and well known, with venues that have hosted weddings for years. Traffic can get busy here on weekend evenings, so we plan timing around that.\n\nWe've handled entries at venues along Pandit Nehru Marg and know the area well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Pandit Nehru Marg that means knowing this established, central part of the city and how to time entries around its evening traffic.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, keeping timing tight even on a busy central road.",
    pricingGuidance:
      "On how much does baraat cost for a Pandit Nehru Marg entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 3 weeks' notice during peak season is a safe bet, given how popular this central road is.\n\nA rough headcount for the baraati group and your exact venue helps us plan the setup properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue on Pandit Nehru Marg, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost on Pandit Nehru Marg?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Pandit Nehru Marg a central location?",
        a: "Yes, it's one of Jamnagar's well-known central roads, easily reachable from across the city.",
      },
      {
        q: "How early should I book for a Pandit Nehru Marg wedding?",
        a: "3 weeks ahead during wedding season (November to February) is a safe window.",
      },
      {
        q: "Is traffic an issue for a baraat entry here?",
        a: "It can get busy on weekend evenings, so we plan the truck's arrival timing around that.",
      },
      {
        q: "Is the vintage car included in every package?",
  ...
  "jamnagar-patel-colony": {
    slug: "jamnagar-patel-colony",
    intro:
      "Patel Colony is a well-settled residential neighborhood in Jamnagar, with a mix of community halls and local venues that regularly host weddings. A baraat entry here has that comfortable, familiar neighborhood feel.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all coordinated as one team.",
    localArea:
      "Patel Colony's roads are generally manageable for truck access, being a settled residential area, though we always confirm your exact venue's approach lane in advance.\n\nWe've handled entries in Patel Colony and the surrounding neighborhood.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Patel Colony that means knowing this settled residential neighborhood and its community halls well.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through Jamnagar's residential neighborhoods.",
    pricingGuidance:
      "On how much does baraat cost for a Patel Colony entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group helps us plan the setup properly for your venue.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Patel Colony, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Patel Colony, Jamnagar?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Are the roads here manageable for a truck entry?",
      ...
      {
        q: "How early should I book for a Patel Colony wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Is Patel Colony a residential area?",
        a: "Yes, it's a settled residential neighborhood with a good mix of community halls used for weddings.",
      },
      {
        q: "Is the vintage car included in every package?",
  ...
  "jamnagar-bedi-bandar-road": {
    slug: "jamnagar-bedi-bandar-road",
    intro:
      "Bedi Bandar Road runs toward Jamnagar's port area, wide and open in stretches, with a handful of venues along the way. A baraat entry here has plenty of room to be a big, visible celebration.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, all handled as one team.",
    localArea:
      "Bedi Bandar Road is generally wide, making truck access straightforward for most stretches. We plan the route based on your exact venue along this corridor.\n\nWe've handled entries along Bedi Bandar Road and know the area well.",
    whatsIncluded:
    ...
    whyUs:
      "We're a Gujarat-based baraat planner, and for Bedi Bandar Road that means being ready to make the most of the open road here for a bigger, more visible entry.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are comfortable with the open-road setups common along this corridor.",
    pricingGuidance:
      "On how much does baraat cost for a Bedi Bandar Road entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 2-3 weeks' notice during peak season is usually enough for this area.\n\nA rough headcount for the baraati group and your exact venue helps us plan the setup properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue on Bedi Bandar Road, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost on Bedi Bandar Road?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Is Bedi Bandar Road good for a big truck entry?",
        a: "Yes, it's generally wide, giving good room for a bigger, more visible entry.",
      },
      {
        q: "How early should I book for a Bedi Bandar Road wedding?",
        a: "2-3 weeks ahead during wedding season (November to February) is usually enough.",
      },
      {
        q: "Does Bedi Bandar Road lead toward the port?",
        a: "Yes, it runs toward Jamnagar's port area, wide and open in stretches.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
  ...
  "jamnagar-jamnagar-town": {
    slug: "jamnagar-jamnagar-town",
    intro:
      "Jamnagar Town is the historic heart of the city, with old-style markets, established halls, and easy access from every direction. A baraat entry here feels like a proper city-center celebration.\n\nPlanMyBaraat brings the whole entry together as one booking: a double decker dj truck for baraat, a dhol team, a vintage car or baggi, and a safa team, so you don't have to arrange a dj truck rental, dhol group, car, and turban stylist separately.",
    localArea:
      "Jamnagar Town has a mix of older, narrower lanes and some wider connecting roads, so we plan the truck's route carefully based on your exact venue.\n\nWe've handled entries in and around Jamnagar Town and know its lanes well.",
    whatsIncluded:
      "Every package includes the DJ truck, sound system, and DJ artist. Raj Tilak comes with 2 dhol and chhatri lights. Rajwada adds 2 more dhol and a teddy or gorilla performer. Maharaja brings moving LED panels and the groom's name lit up. Signature, the top package, adds a security team plus pyro and confetti effects timed to the truck's arrival.\n\nThe vintage car and safa team come with every package from Raj Tilak upward, so even the entry-level package includes a proper car and full turban styling for the baraati group.",
    whyUs:
      "We're a Gujarat-based baraat planner, and for Jamnagar Town that means knowing exactly which lanes work for a full-size truck and where a shorter walk-in makes more sense.\n\nOur drivers, DJs, dhol players, and safa artists work with us regularly, and are experienced with entries through the city's older, denser core.",
    pricingGuidance:
      "On how much does baraat cost for a Jamnagar Town entry: it depends on the package, dhol count, and any extra effects like pyro or confetti. Raj Tilak is the most affordable starting point. Signature costs more because it includes more — bigger truck branding, more dhol, LED visuals, and a security team.\n\nWe quote based on your actual date and guest count. Message us on WhatsApp and we'll respond with a real quote, usually within the hour.",
    planningNotes:
      "Wedding season runs November to February. 3 weeks' notice during peak season is a safe bet, since town venues are popular.\n\nA rough headcount for the baraati group and your exact venue helps us plan the route properly.",
    closing:
      "Message us on WhatsApp with your wedding date, your venue in Jamnagar Town, and roughly how many guests are in the baraat. We'll recommend a package and confirm the truck's available, usually within the hour.",
    faqs: [
      {
        q: "How much does a baraat setup cost in Jamnagar Town?",
        a: "It depends on the package, dhol count, and any extra effects. Raj Tilak is our most affordable package and Signature is the most complete. Message your date and venue on WhatsApp for a real quote.",
      },
      {
        q: "Can the truck reach venues in Jamnagar Town's older lanes?",
        a: "In most cases yes, though we check your exact venue in advance since some lanes are narrower and may need a shorter walk-in.",
      },
      {
        q: "How early should I book for a Jamnagar Town wedding?",
        a: "3 weeks ahead during wedding season (November to February) is a safe window, since these venues are popular.",
      },
      {
        q: "Is Jamnagar Town easy for guests to reach?",
        a: "Yes, it's the historic heart of the city, with easy access from every direction.",
      },
      {
        q: "Is the vintage car included in every package?",
        a: "Yes, starting from Raj Tilak. You don't need to arrange a car separately. The Signature package upgrades this to a premium American vintage car.",
